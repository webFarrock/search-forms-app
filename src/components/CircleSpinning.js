...
export default CircleSpinning => {
    return (
        <div className="circle--spinning">
            <svg
                style={{enableBackground: 'new 0 0 190 190'}}
                version="1.1"
                x="0px"
                y="0px"
                viewBox="0 0 190 190"
                ...
                <g id="submit">
                    <g id="Ellipse_1">
                        ...
                        <linearGradient id="SVGID_1_"
                                        gradientUnits="userSpaceOnUse" x1="142.499" y1="0"
                                        x2="142.499" y2="190">
                        ...
                        <path className="st1" d="M95,0C95,0,95,0,95,0l0,1.7c0,0,0,0,0,0c51.5,0,93.3,41.9,93.3,93.3c0,51.5-41.9,93.3-93.3,93.3c0,0,0,0,0,0
